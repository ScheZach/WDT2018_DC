...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if(empty($question_err) && empty($date_err) && empty($id_err)) {
    $sql = "INSERT INTO question (question, submitDate, userId) VALUES (?,?,?)";
    if($stmt = $conn->prepare($sql)) {
      $stmt->bind_param("ssi", $param_question, $param_date, $param_id);
